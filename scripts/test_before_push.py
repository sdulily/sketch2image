...
if __name__ == '__main__':
    ...
    if not os.path.exists('./checkpoints/horse2zebra_pretrained/latest_net_G_A.pth'):
    ...
    if not os.path.exists('./checkpoints/facades_label2photo_pretrained/latest_net_G_A.pth'):
